...
void main(List<String> args) async {
  ...
  for (var i = 0; i < numRuns; i++) {
    await evolve(
        ...
        chat: true,
        useSChMUSR: true,
        folder: '../results/results_withCats_SChMUSR_fear_chat_$i',
        timeout: timeout,
...
//     'Sure',
//     "I don't trust them",
//     'I am attacking alpha',
//     'alpha attacked me',
//     'tango and bravo are a group',
//     'lets do it next round',
//     'maybe',
//     "Let's form a team",
//     'Can we be friends?',
...
//     'I forgot to submit',
//     'I gave you 2',
//     'how much are you giving to me',
//     'How much are you stealing from them',
//     'are you stealing from them?',
//     'should we attack them?',
//     "Let's attack next round",
//     'gib 10',
//     'why?',
//     'are they good?',
//     'deal',
...
//     'attack your friends'
//   ];
//   for (final phrase in listOfPhrases) {
//     final response = await getResponse(phrase);
//     print('$phrase -> ${response.body}');
//   }
}
...
//       'text': text,
//       'n_preds': nPreds.toString(),
//     };
//   }
// }

// Future getResponse(String input) {
//   final request = jsonEncode(ConvertRequest(text: input, nPreds: 3));
//   final uri = Uri(scheme: 'http', host: 'localhost', port: 8000, path: '/convert/');

//   return http.post(uri, body: request, headers: {'Content-Type': 'application/json'});
// }
